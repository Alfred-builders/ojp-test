...
const metalOptions: { value: NonNullable<OrInvestissement["metal"]>; label: string }[] = [
  { value: "Or", label: "Or" },
  { value: "Argent", label: "Argent" },
  { value: "Autres", label: "Autres" },
];

interface OrInvestissementToolbarProps {
  search: string;
  onSearchChange: (value: string) => void;
  metalFilter: NonNullable<OrInvestissement["metal"]> | null;
  onMetalFilterChange: (value: NonNullable<OrInvestissement["metal"]> | null) => void;
}
...
export function OrInvestissementToolbar({
  search,
  onSearchChange,
  metalFilter,
  onMetalFilterChange,
}: OrInvestissementToolbarProps) {
  const hasFilters = metalFilter !== null;
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <FilterPopover
        ...
        onChange={(v) =>
          onMetalFilterChange(v as NonNullable<OrInvestissement["metal"]> | null)
        }
      />
      {hasFilters && (
        <Button
