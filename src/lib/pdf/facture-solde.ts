      ...
      h(View, { style: { width: 240 } },
        ...
        h(View, { style: { marginTop: 4 } },
          h(View, { style: s.totRow },
            h(Text, { style: { ...s.totLabel, color: C.gray } }, `Acompte vers\u00E9 (${numeroAcompte})`),
            h(Text, { style: { ...s.totValue, color: C.gray } }, `- ${fmt(montantAcompte)}`))),
        h(View, { style: s.totGoldLine }),
        h(View, { style: s.netRow },
          h(Text, { style: s.netLabel }, "SOLDE \u00C0 R\u00C9GLER"),
          h(Text, { style: s.netValue }, fmt(montantSolde))))),
