-- ============================================================
-- Migration 079: Autoriser devis_envoye → en_retractation
-- Le code passe directement de devis_envoye à en_retractation
-- sans passer par accepte (étape intermédiaire inutile)
-- ============================================================
